 ...
 *4
 */
@WebServlet(urlPatterns = "/*", loadOnStartup = 0) //ques:这个注解是什么用处
public class DispatcherServlet extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(handler != null) {
			...
			/*
			 * guess:表单编码不同时，getParameter()可能获取不了参数，需要通过流获取，
			...
			//调用带Behavior注解的配对方法
			Object result = ReflectionUtil.invokeMethod(controllerObj, handler.getActionMethod(), param);
